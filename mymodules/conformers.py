...
Note by AM:
See below for source & usage.
Makes conformer minimization really easy.
https://www.programcreek.com/python/?code=deepchem%2Fdeepchem%2Fdeepchem-master%2Fdeepchem%2Futils%2Fconformers.py
"""
...
class ConformerGenerator(object):
    ...
    * http://pubs.acs.org/doi/full/10.1021/ci2004658
    ...
    def get_molecule_force_field(self, mol, conf_id=None, **kwargs):
        ...
        # this here is the actual calculation heavy portion I would say.
        # TODO maybe this can be parallelized?
        # managed finally without, though perhaps more efficient if here?
